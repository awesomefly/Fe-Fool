...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    # Start training
    t0 = time.time()
    nw = max(round(hyp['warmup_epochs'] * nb), 20)  # number of warmup iterations, max(3 epochs, 100 iterations)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/self_data.yaml', help='dataset.yaml path')
